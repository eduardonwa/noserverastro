import { c as createComponent, a as createAstro, m as maybeRenderHead, b as addAttribute, r as renderTemplate, e as renderHead, f as renderSlot, g as renderComponent } from '../chunks/astro/server_CRA5xZxQ.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
...
const astroLogo = new Proxy({"src":"/_astro/astro.Dm8K3lV8.svg","width":115,"height":48,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/root/code/gojira/src/assets/astro.svg";
							}
...
const background = new Proxy({"src":"/_astro/background.BPKAcmfN.svg","width":1440,"height":1024,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/root/code/gojira/src/assets/background.svg";
							}
...
}, "/root/code/gojira/src/components/Welcome.astro", void 0);
...
}, "/root/code/gojira/src/layouts/Layout.astro", void 0);
...
}, "/root/code/gojira/src/pages/index.astro", void 0);

const $$file = "/root/code/gojira/src/pages/index.astro";
const $$url = "";
